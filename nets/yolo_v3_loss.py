...
class YOLOLoss(nn.Module):
    def __init__(self, anchors, img_size, cuda):
    ...
    def forward(self, input, targets=None):
        ...
        # 找到哪些先验框内部包含物体
        mask, noobj_mask, tx, ty, tw, th, tconf, box_loss_scale_x, box_loss_scale_y =\
    ...
    def get_target(self, target, anchors, in_w, in_h, ignore_threshold):
        ...
        return mask, noobj_mask, tx, ty, tw, th, tconf, box_loss_scale_x, box_loss_scale_y
